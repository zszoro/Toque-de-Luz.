...
const DEFAULT_PROD_PUBLIC_KEY = "APP_USR-1d4fa563-5bb4-4627-b487-a76402bb2005";
...
export function getActiveMercadoPagoConfig() {
    ...
    if (mode === MP_MODE_PROD) {
        return {
            ...
            publicKey: String(process.env.MP_PROD_PUBLIC_KEY || (!isLikelyTestCredential(legacyPublicKey) ? legacyPublicKey : "") || DEFAULT_PROD_PUBLIC_KEY).trim()
        };
    }
